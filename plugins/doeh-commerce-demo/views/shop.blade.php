...
@section('title', 'DOEH Commerce demo — shop')
...
@section('content')
    ...
    @forelse ($products as $p)
        <div class="card row">
            ...
            <form method="POST" action="{{ url('/doeh-demo/cart/add') }}">
                @csrf
    ...
    @empty
        <div class="card muted">No demo products configured. Add some in Plugins → DOEH Commerce Demo → Settings.</div>
    @endforelse

    <p style="margin-top:16px;"><a class="plain" href="{{ url('/doeh-demo/cart') }}">View cart →</a></p>
@endsection
