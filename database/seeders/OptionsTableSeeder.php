...
class OptionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $option_name  = array('siteurl', 'home', 'blogname', 'blogdescription', 'theme', 'admin_email', 'version',
            ...
            'mail_enabled', 'mail_provider', 'mailgun_domain', 'mailgun_secret', 'mail_from', 'spa_url', 'cors_origins', 'frontend_mode', 'admin_login_path', 'otp_channel', 'active_plugins', 'plugin_versions');
