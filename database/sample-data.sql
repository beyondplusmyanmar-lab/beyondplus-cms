...
-- ---------------------------------------------------------------------------
-- Full schema for every table + seed data for generic CMS infrastructure only
-- (modules, permissions, languages, options). Contains NO production PII:
-- users/customers/activity_log and real site content are schema-only (empty).
