...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,500;9..144,600;9..144,700;9..144,900&family=Libre+Franklin:wght@400;500;600;700&family=Noto+Sans+Myanmar:wght@400;500;600&display=swap">
    <style>
        :root {
        ...
        body { background: var(--md-paper); color: var(--md-ink);
            font-family: "Libre Franklin", system-ui, -apple-system, "Noto Sans Myanmar", sans-serif;
        ...
        .md-kicker { font-family:"Libre Franklin",sans-serif; font-size:.72rem; font-weight:700;
        ...
        .md-nav .nav-link { font-family:"Libre Franklin",sans-serif; font-weight:600; font-size:.86rem;
        ...
        .md-byline { font-family:"Libre Franklin",sans-serif; font-size:.78rem; color:var(--md-muted);
            letter-spacing:.02em; }
        ...
        .btn-md-ghost { border:1px solid var(--md-ink); border-radius:0; font-family:"Libre Franklin",sans-serif;
        ...
        .md-tag { display:inline-block; font-family:"Libre Franklin",sans-serif; font-size:.7rem; font-weight:700;
        ...
        /* sidebar */
        .md-aside-title { font-family:"Libre Franklin",sans-serif; font-size:.74rem; font-weight:700;
        ...
        /* ── Burmese typography fixes ──
           Latin tracking (letter-spacing) + all-caps pull apart Myanmar stacked
           glyph clusters, and the drop-cap grabs a partial cluster. Neutralise
           those for the Myanmar locale and give stacked diacritics room to breathe. */
        html[lang="mm"] .md-kicker, html[lang="mm"] .md-nav .nav-link,
        html[lang="mm"] .btn-md-ghost, html[lang="mm"] .md-tag,
        html[lang="mm"] .md-aside-title, html[lang="mm"] .md-byline,
        html[lang="mm"] .md-topbar, html[lang="mm"] .md-lang a {
            letter-spacing: normal; text-transform: none; }
        html[lang="mm"] h1, html[lang="mm"] h2, html[lang="mm"] h3,
        html[lang="mm"] h4, html[lang="mm"] h5, html[lang="mm"] .md-serif {
            line-height: 1.45; letter-spacing: normal; }
        html[lang="mm"] .md-lead-title, html[lang="mm"] .md-story-title,
        html[lang="mm"] .md-article-title { line-height: 1.35; }
        html[lang="mm"] .bp-content { line-height: 1.9; }
        html[lang="mm"] .bp-content > p:first-of-type::first-letter {
        ...
        @media (prefers-reduced-motion: reduce) {
            ...
            *, *::before, *::after { animation: none !important; transition: none !important; }
            ...
            a:hover, .md-card:hover { transform: none !important; }
        }
    </style>
    @stack('styles')
</head>
<body class="d-flex flex-column min-vh-100">
    ...
    @include('theme.meridian.layouts.header')

    <main class="flex-grow-1">
        @yield('content')
    </main>

    @include('theme.meridian.layouts.footer')
