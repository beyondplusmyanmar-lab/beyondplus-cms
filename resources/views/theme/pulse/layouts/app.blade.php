...
<head>
    ...
    <style>
        ...
        /* ── Burmese typography fixes ──
           ...
           heading tracking, break Myanmar clusters. Neutralise for the mm locale. */
        html[lang="mm"] .pl-eyebrow, html[lang="mm"] .pl-pill {
            letter-spacing: normal; text-transform: none; }
        html[lang="mm"] h1, html[lang="mm"] h2, html[lang="mm"] h3,
        html[lang="mm"] h4, html[lang="mm"] h5, html[lang="mm"] .pl-display,
        html[lang="mm"] .pl-nav .navbar-brand {
...
<body class="d-flex flex-column min-vh-100">
    ...
    @include('theme.pulse.layouts.header')

    <main class="flex-grow-1">
        @yield('content')
    </main>

    @include('theme.pulse.layouts.footer')
