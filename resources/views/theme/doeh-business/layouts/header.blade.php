@php
    ...
    $mm = app()->getLocale() === 'mm';
    $logoOpt = trim((string) bp_option('biz_logo'));
...
<header class="site">
    <div class="wrap bar">
        <a class="brand serif" href="{{ url('/') }}">@if ($logoUrl)<img src="{{ $logoUrl }}" alt="{{ $siteName }}" style="height:36px; width:auto; display:block;">@else{{ $siteName }}@endif</a>
        <nav>
