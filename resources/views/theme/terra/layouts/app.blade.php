...
<head>
    ...
    <style>
        ...
        /* ── Burmese typography fixes ──
           ...
           tracking that crowd Myanmar glyph clusters in the Myanmar locale. */
        html[lang="mm"] .tr-cat, html[lang="mm"] .tr-date, html[lang="mm"] .tr-label {
            letter-spacing: normal; text-transform: none; }
        html[lang="mm"] h1, html[lang="mm"] h2, html[lang="mm"] h3,
        html[lang="mm"] h4, html[lang="mm"] h5, html[lang="mm"] .tr-display,
        html[lang="mm"] .tr-nav .navbar-brand, html[lang="mm"] .tr-row-title {
...
<body class="d-flex flex-column min-vh-100">
    ...
    @include('theme.terra.layouts.header')

    <main class="flex-grow-1">
        @yield('content')
    </main>

    @include('theme.terra.layouts.footer')
