  ...
  <div class="row">
    <div class="col-md-12"> 
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group" id="event-date-group" style="{{ $post->post_type == 'event' ? '' : 'display:none;' }}">
                                ...
                                <input type="datetime-local" name="event_at" id="start_date" class="form-control"
                                       value="{{ $post->event_at ? \Carbon\Carbon::parse($post->event_at)->format('Y-m-d\TH:i') : date('Y-m-d\TH:i') }}">
        ...
        <div class="col-md-3 tile">
            ...
            <div class="box box-danger">
                <div class="box-body">
                    {{ Form::label('Translate') }} <a href="{{url('/bp-admin/news/'.$post->id.'/translate')}}"> Translate</a><br />
                    <div class="col-md-12 form-group">
