        ...
        <div class="col-md-6 col-lg-5">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4 p-md-5">
                    ...
                    <p class="text-muted text-center mb-4">Enter your phone number and we'll send a verification code.</p>
                    ...
                    <form method="POST" action="{{ url('customer/forgot-pass') }}">
                        ...
                        <button type="submit" class="btn btn-primary w-100" name="verify">Send code</button>
                    </form>
