...
class OtapiService
{
    ...
    public function batchSimplifiedAddItemsToBasket($itemData, $comment)
    {
    ...
    public function CreateSalesOrder($sessionId, $comment)
    {
    ...
    // order detail
    public function GetSalesOrderDetailsForOperator($orderid)
    {
