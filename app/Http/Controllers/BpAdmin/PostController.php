...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bp-admin.post.index', ['post' => $post]);
    }

    public function create()
    {
        return view('bp-admin.post.add', ['taxes' => $this->taxes]);
    ...
    public function edit($id)
    {
        ...
        return view('bp-admin.post.edit', ['post' => $post, 'taxes' => $this->taxes, 'tax_type' => $tax_type]);
    ...
    public function translate($id)
    {
        ...
        return view('bp-admin.post.translate', ['post' => $post, 'taxes' => $this->taxes, 'tax_type' => $tax_type, 'translate_id' => $id]);
    }
}
